...
// Root CA "GTS Root R1" (Google Trust Services) yang menandatangani sertifikat
// *.firebasedatabase.app. Dipakai langsung (bukan lewat esp_crt_bundle) karena
// bundle bawaan ESP-IDF gagal menemukan root yang cocok di device ini.
static const char GTS_ROOT_R1_PEM[] =
"-----BEGIN CERTIFICATE-----\n"
